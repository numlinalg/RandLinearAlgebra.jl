# RandLinearAlgebra
[![](https://img.shields.io/badge/docs-dev-blue.svg)](https://numlinalg.github.io/RandLinearAlgebra.jl/dev)
[![Runtests](https://github.com/numlinalg/RandLinearAlgebra.jl/actions/workflows/Runtests.yml/badge.svg)](https://github.com/numlinalg/RandLinearAlgebra.jl/actions/workflows/Runtests.yml)
[![codecov](https://codecov.io/github/numlinalg/RandLinearAlgebra.jl/branch/v0.2-main/graph/badge.svg?token=GI7YUNM4YO)](https://codecov.io/github/numlinalg/RandLinearAlgebra.jl)
[![Code Style: Blue](https://img.shields.io/badge/code%20style-blue-4495d1.svg)](https://github.com/invenia/BlueStyle)

RandLinearAlgebra is a Julia package that implements standard Randomized Linear Algebra algorithms and provides means for performance comparison.
...
We would also like to thank the student contributors to this library: 
- Tongtong Jin
- Christian Varner
- Tunan Wang
