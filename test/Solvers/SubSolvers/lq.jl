@testset "LQ SubSolver Tests" begin
    ...
    @testset "LQ SubSolver Recipe" begin
        ...
        @test fieldnames(LQSolverRecipe) == (:A, :T, :work)
        @test fieldtypes(LQSolverRecipe) == (AbstractArray, Matrix, AbstractVector)
    end
